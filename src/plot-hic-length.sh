...
#        printf "set style line 5 lt 1 lw 3 pt 3 linecolor rgb \"violet\"\n"
	printf "set xlabel \"Paired Ends Mapping Length\"\n"
	printf "set ylabel \"Frequency / 100\"\n"
        printf "plot [ 1 to 100000000 ] [ 0.0001 to 50.0 ] \"human-hic-len.freq\" title \"Human-HiC\" with lines ls 1,\"hummingbird-hic.freq\" title \"Hummingbird-HiC\" with lines ls 2,\"fMasArm1-hic.freq\" title \"Fish MasArm-HiC\" with lines ls 3,\"tdevil-hic.freq\" title \"Tasmanian Devil-HiC\" with lines ls 4"
}
