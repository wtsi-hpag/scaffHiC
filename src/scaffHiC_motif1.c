...
/* ====================================================  */
{
     int i;
//     char **rdname;
     char *ptr,line[500],line2[500],Nameout[100],RC,motif[5] = "GATC";
...
/*   read the cigar line file   */
     ...
     if((namef2 = fopen(argv[args],"r")) == NULL)
     {
...
//       printf("%d %d %d %s %s",num_out,num_align,(num_align+1)%4,Nameout,line);
       ...
       {
         memset(line2,'\0',500);
         pch = strstr(line,motif);
         if(pch != NULL)
         {
           fprintf(namef3,"HiC-reads_%010ld_1\n",num_align/4);
           fprintf(namef,"@HiC-reads_%010ld_1\n",num_align/4);
         }
         else
         {
           fprintf(namef3,"HiC-reads_%010ld_N\n",num_align/4);
           fprintf(namef,"@HiC-reads_%010ld_N\n",num_align/4);
//           printf("%s %s\n",pch,line);
         }
